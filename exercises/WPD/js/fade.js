...
fader = new fadeObject('fade0', '0a0a0a', '668866', 20, 20);

fader.msg[1] = "As sky is tall...";
fader.msg[2] = "...this is our home.";

function fadeIn(what)
{
//	<span onmouseover="fader[0].fade(1, true);" onmouseout="fader[0].fade(1, false);">Please touch me</span>
}
