...
class Query 
{
	...
	public:
		...
		std::set<TextQuery::sentence_no> eval(const TextQuery&) const;
...
class Query_base 
{
	...
	protected:
		...
		typedef TextQuery::sentence_no sentence_no;
		virtual ~Query_base() { }

	private:

		// eval returns the |set| of sentences that this Query matches
		virtual std::set<sentence_no> eval(const TextQuery&) const = 0;
...
class WordQuery : public Query_base 
{
	...
	private:
		...
		std::set<sentence_no> eval(const TextQuery &t) const;
...
class AndQuery : public BinaryQuery 
{
	...
	private:
		...
		std::set<sentence_no> eval(const TextQuery&) const;
};
