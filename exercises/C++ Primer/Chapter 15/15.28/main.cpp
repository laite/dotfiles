// Ex 15.28: vector of class instances
...
int main()
{
	...
	// since vector is of type Item_base, items
	// have been stripped of their derived attributes,
	// such as overriden net_price() function.
	//
	// Instead, Item_base::net_price is called here
